...
export function FastCommentsCommentView(props: CommentViewProps) {
    ...
    return <View style={styles.comment.root}>
        <View style={styles.comment.topRight}>
            ...
            {!(state.config.readonly.get()) && CommentMenu(props)}
        </View>
        ...
        <CommentBottom comment={comment} state={state} styles={styles} onVoteSuccess={onVoteSuccess} onReplySuccess={onReplySuccess} onAuthenticationChange={onAuthenticationChange} />
        {
